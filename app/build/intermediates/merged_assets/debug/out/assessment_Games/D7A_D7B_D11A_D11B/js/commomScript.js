...
function clickOnCode(ele) { 	// onclick of direct coding
	...
	clickOption=scoredmarks= $(ele).text();
	D7A.answerFlag=true;
}
...
createNumberDivs = function(parentDiv)
{
    ...
    for(i=0; i<4; i++)
    {
        ...
        if(i==3){
			...
			zerobutton.setAttribute('class','borderClass buttonClass noPadding col-xs-2 col-sm-2 col-md-2 col-lg-2 col-sm-offset-4 col-xs-offset-4 col-lg-offset-4 col-md-offset-4 nopadding'); 
			...
			{		 
				...
				button.setAttribute('class','borderClass buttonClass noPadding  col-xs-2 col-sm-2 col-md-2 col-lg-2 col-sm-offset-1 col-xs-offset-1 col-lg-offset-1 col-md-offset-1 nopadding'); 
