...
public final class ParaSttReadingFragment_
    extends com.pratham.foundation.ui.contentPlayer.paragraph_stt.ParaSttReadingFragment
    implements BeanHolder, HasViews, OnViewChangedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(R.layout.fragment_para_reading, container, false);
        }
        return contentView_;
    }
    ...
    private void init_(Bundle savedInstanceState) {
        ...
        this.presenter = ParaSttReadingPresenter_.getInstance_(getActivity(), this);
    }
    ...
    public static ParaSttReadingFragment_.FragmentBuilder_ builder() {
        return new ParaSttReadingFragment_.FragmentBuilder_();
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        this.parapax_image = hasViews.internalFindViewById(R.id.parapax_image);
        ...
        if (this.btn_Stop!= null) {
            this.btn_Stop.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.stopBtn();
                }
            }
            );
        }
        if (this.btn_Mic!= null) {
            this.btn_Mic.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.sttMethod();
                }
            }
            );
        }
        if (this.btn_Play!= null) {
            this.btn_Play.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.playReading();
                }
            }
            );
        }
        if (this.btn_previouspage!= null) {
            this.btn_previouspage.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.gotoPrevPage();
                }
            }
            );
        }
        if (this.btn_submit!= null) {
            this.btn_submit.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.submitTest();
                }
            }
            );
        }
        if (this.btn_nextpage!= null) {
            this.btn_nextpage.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.gotoNextPage();
                }
            }
            );
        }
        if (this.clean_stt!= null) {
            this.clean_stt.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.sttClearClicked();
                }
            }
            );
        }
        if (this.bt_edit_ok!= null) {
            this.bt_edit_ok.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.editOKClicked();
                }
            }
            );
        }
        if (this.floating_img!= null) {
            this.floating_img.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    ParaSttReadingFragment_.this.showPageImageDialog();
                }
            }
            );
        }
    ...
    public void showLoader() {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                ParaSttReadingFragment_.super.showLoader();
            }
        }
        , 0L);
    }
    ...
    public void dismissLoadingDialog() {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                ParaSttReadingFragment_.super.dismissLoadingDialog();
            }
        }
        , 0L);
    }
    ...
    public void setCategoryTitle(final String title) {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                ParaSttReadingFragment_.super.setCategoryTitle(title);
            }
        }
        , 0L);
    }
    ...
    public void initializeContent(final int pageNo) {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                ParaSttReadingFragment_.super.initializeContent(pageNo);
            }
        }
        , 0L);
    }
    ...
    public void allCorrectAnswer() {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                ParaSttReadingFragment_.super.allCorrectAnswer();
            }
        }
        , 0L);
    }
    ...
    public void setCorrectViewColor() {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                ParaSttReadingFragment_.super.setCorrectViewColor();
            }
        }
        , 0L);
    }
    ...
    public void setSttResult(final ArrayList<String> sttResult) {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                ParaSttReadingFragment_.super.setSttResult(sttResult);
            }
        }
        , 0L);
    }
    ...
    public void Stt_onResult(final ArrayList<String> sttResult) {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0L, "") {
            ...
            public void execute() {
                try {
                    ParaSttReadingFragment_.super.Stt_onResult(sttResult);
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<ParaSttReadingFragment_.FragmentBuilder_, com.pratham.foundation.ui.contentPlayer.paragraph_stt.ParaSttReadingFragment>
    {

        @Override
        public com.pratham.foundation.ui.contentPlayer.paragraph_stt.ParaSttReadingFragment build() {
            ParaSttReadingFragment_ fragment_ = new ParaSttReadingFragment_();
