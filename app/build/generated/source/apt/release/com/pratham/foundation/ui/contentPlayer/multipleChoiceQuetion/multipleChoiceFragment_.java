...
public final class multipleChoiceFragment_
    extends com.pratham.foundation.ui.contentPlayer.multipleChoiceQuetion.multipleChoiceFragment
    implements BeanHolder, HasViews, OnViewChangedListener
{
    ...
    private void init_(Bundle savedInstanceState) {
        ...
        this.presenter = MultipleChoicePresenter_.getInstance_(getActivity(), this);
    }
    ...
    public static multipleChoiceFragment_.FragmentBuilder_ builder() {
        return new multipleChoiceFragment_.FragmentBuilder_();
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        if (this.previous!= null) {
            this.previous.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    multipleChoiceFragment_.this.onPreviousClick();
                }
            }
            );
        }
        if (this.next!= null) {
            this.next.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    multipleChoiceFragment_.this.onNextClick();
                }
            }
            );
        }
        if (this.submitBtn!= null) {
            this.submitBtn.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    multipleChoiceFragment_.this.onsubmitBtnClick();
                }
            }
            );
        }
        if (this.show_answer!= null) {
            this.show_answer.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    multipleChoiceFragment_.this.showAnswer();
                }
            }
            );
        }
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<multipleChoiceFragment_.FragmentBuilder_, com.pratham.foundation.ui.contentPlayer.multipleChoiceQuetion.multipleChoiceFragment>
    {

        @Override
        public com.pratham.foundation.ui.contentPlayer.multipleChoiceQuetion.multipleChoiceFragment build() {
            multipleChoiceFragment_ fragment_ = new multipleChoiceFragment_();
