...
public final class STTSummaryFragment_
    extends com.pratham.foundation.ui.contentPlayer.paragraph_stt.STTSummaryFragment
    implements BeanHolder, HasViews, OnViewChangedListener
{
    ...
    public static STTSummaryFragment_.FragmentBuilder_ builder() {
        return new STTSummaryFragment_.FragmentBuilder_();
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        if (view_btn_Stop!= null) {
            view_btn_Stop.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    STTSummaryFragment_.this.stopBtn();
                }
            }
            );
        }
        if (this.reset_btn!= null) {
            this.reset_btn.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    STTSummaryFragment_.this.resetBtn();
                }
            }
            );
        }
        if (view_hint_btn!= null) {
            view_hint_btn.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    STTSummaryFragment_.this.showHint();
                }
            }
            );
        }
        if (this.ib_mic!= null) {
            this.ib_mic.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    STTSummaryFragment_.this.sttMethod();
                }
            }
            );
        }
        if (this.btn_prev!= null) {
            this.btn_prev.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    STTSummaryFragment_.this.gotoPrevPage();
                }
            }
            );
        }
        if (this.submit!= null) {
            this.submit.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    STTSummaryFragment_.this.submitTest();
                }
            }
            );
        }
        if (this.btn_next!= null) {
            this.btn_next.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    STTSummaryFragment_.this.gotoNextPage();
                }
            }
            );
        }
    ...
    public void showLoader() {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                STTSummaryFragment_.super.showLoader();
            }
        }
        , 0L);
    }
    ...
    public void dismissLoadingDialog() {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                STTSummaryFragment_.super.dismissLoadingDialog();
            }
        }
        , 0L);
    }
    ...
    public void setCategoryTitle(final String title) {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                STTSummaryFragment_.super.setCategoryTitle(title);
            }
        }
        , 0L);
    }
    ...
    public void initializeContent(final int pageNo) {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                STTSummaryFragment_.super.initializeContent(pageNo);
            }
        }
        , 0L);
    }
    ...
    public void setAnswerToView(final ArrayList<String> sttResult) {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                STTSummaryFragment_.super.setAnswerToView(sttResult);
            }
        }
        , 0L);
    }
    ...
    public void Stt_onResult(final ArrayList<String> sttResult) {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0L, "") {
            ...
            public void execute() {
                try {
                    STTSummaryFragment_.super.Stt_onResult(sttResult);
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<STTSummaryFragment_.FragmentBuilder_, com.pratham.foundation.ui.contentPlayer.paragraph_stt.STTSummaryFragment>
    {

        @Override
        public com.pratham.foundation.ui.contentPlayer.paragraph_stt.STTSummaryFragment build() {
            STTSummaryFragment_ fragment_ = new STTSummaryFragment_();
