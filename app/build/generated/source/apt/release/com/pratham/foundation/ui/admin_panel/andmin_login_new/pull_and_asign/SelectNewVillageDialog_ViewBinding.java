...
public class SelectNewVillageDialog_ViewBinding implements Unbinder {
  private SelectNewVillageDialog target;
  ...
  @UiThread
  public SelectNewVillageDialog_ViewBinding(SelectNewVillageDialog target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SelectNewVillageDialog_ViewBinding(final SelectNewVillageDialog target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SelectNewVillageDialog target = this.target;
