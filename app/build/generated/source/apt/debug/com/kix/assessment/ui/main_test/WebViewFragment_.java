...
public final class WebViewFragment_
    extends com.kix.assessment.ui.main_test.WebViewFragment
    implements BeanHolder, HasViews, OnViewChangedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(R.layout.fragment_web_view, container, false);
        }
        return contentView_;
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        this.main_rl = hasViews.internalFindViewById(R.id.main_rl);
        init();
    }
    ...
    public void createWebView(final String GamePath) {
        UiThreadExecutor.runTask("", new Runnable() {
            ...
            @Override
            public void run() {
                WebViewFragment_.super.createWebView(GamePath);
            }
        }
        , 0L);
    }
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<WebViewFragment_.FragmentBuilder_, com.kix.assessment.ui.main_test.WebViewFragment>
    {

        @Override
        public com.kix.assessment.ui.main_test.WebViewFragment build() {
