  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Surveyor` (`svrCode` TEXT NOT NULL, `svrName` TEXT, `svrEmail` TEXT, `svrMobile` TEXT, `svrPassword` TEXT, `svrRegistrationDate` TEXT, `svrCountry` TEXT, `deviceId` TEXT, `sentFlag` INTEGER NOT NULL, PRIMARY KEY(`svrCode`))");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"f1373c79053850ba1fef7673d56c75a8\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsSurveyor.put("deviceId", new TableInfo.Column("deviceId", "TEXT", false, 0));
    ...
    }, "f1373c79053850ba1fef7673d56c75a8", "d77884ce35dd8e00a8b23ce735517bd5");
