  ...
  public List<Modal_ProfileDetails> getProfileData(String svrCode) {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item.StudentAge = _cursor.getString(_cursorIndexOfStudentAge);
        _item.RespondantName = _cursor.getString(_cursorIndexOfRespondantName);
        _item.ExamsGiven = _cursor.getString(_cursorIndexOfExamsGiven);
        _result.add(_item);
      }
      return _result;
    } finally {
