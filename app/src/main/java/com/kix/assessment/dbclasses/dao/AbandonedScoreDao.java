...
public interface AbandonedScoreDao {
    ...
    @Query("select Student.CH01 as StudentName, Student.CH03 as StudentAge, Household.HH02 as RespondantName, count(DISTINCT(AbandonedScore.sessionId)) as ExamsGiven from AbandonedScore\n" +
