...
public interface ScoreDao {
    ...
    @Query("select Student.CH01 as StudentName, Student.CH02 as StudentAge, Household.householdName as HouseholdName, count(DISTINCT(Score.sessionId)) as ExamsGiven from Score\n" +
