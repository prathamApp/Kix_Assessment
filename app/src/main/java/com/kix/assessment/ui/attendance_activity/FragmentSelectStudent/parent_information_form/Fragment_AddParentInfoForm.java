...
/*    @ViewById(R.id.spinner_fathersAge)
    ...
    public String studentId, householdId, parentId;
...
//                    rg_motherIncome.check(R.id.rb_PT02e_No);
    ...
    private void insertPIF() {
        ...
        String parentId = KIX_Utility.getUUID().toString();
        Modal_PIF modalPif = new Modal_PIF();
        modalPif.setParentId(parentId);
        ...
        studentDao.addParentId(parentId, studentId);
