...
//    }
    ...
    //Used to get the country wise language from server
    public void getCountryWiseLang(final String requestType, String url, String countryName) {
        try {
            url = url+countryName;
            AndroidNetworking.get(url)
                    .addHeaders("Content-Type", "application/json")
    ...
    //Used to get the language wise booklet from server
    public void getBookletWiseLanguage(final String requestType, String url, String languageName) {
        try {
